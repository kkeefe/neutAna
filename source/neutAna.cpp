...
int main(int argc, char** argv){
    ...
    try{
        ...
        auto f = rdf.Define("tile_size", count_resets, {"pixel_reset", "pixel_x", "pixel_y"})
                    ...
                    // .Define("neutEnergy", "return lepKE + hadOther + hadTot;")
                    .Define("asic_weight", make_weight, {"fsEnergy", "fsPdg"})
        ...
        std::vector<std::string> cols = {"tile_size", "asic_th2i", "asic_weight", "lepKE", "fsFHC", "fsFileNo",
